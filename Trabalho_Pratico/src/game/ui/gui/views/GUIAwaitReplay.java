...
public class GUIAwaitReplay extends StackPane implements IGUIConstants, Constants {
    ...
    public GUIAwaitReplay(GameObserver game){
        this.game = game;
    ...
    private void loadPane(){
        ...
        menuOpt.getChildren().addAll(logo, menuGameMode, menuPlayerTurn, menuP1H, menuP2H, menuBtnNext);
    ...
    private void refresh() {
        if(game.getCurrentSituation() ==  Situation.AwaitReplay ){
            refreshBoard();
